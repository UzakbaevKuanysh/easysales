(function() {
    ...
    var a = {
        ...
        l = function(a, b, c, d, e) {
            ...
            for (var h = 1; b >= h; h++)
                for (var g = 0; b - h >= g; g++) f[h] || (f[h] = []), f[h][g] || (f[h][g] = {}), f[h][g].x = (1 - c) * f[h - 1][g].x + c * f[h - 1][g + 1].x, f[h][g].y = (1 - c) * f[h - 1][g].y + c * f[h - 1][g + 1].y;
            if (null != d)
    ...
    function() {
        ...
        var a = {
            ...
            h = function(a, b, c) {
                if (a.__ta && a.__ta[b] && delete a.__ta[b][c.__tauid], c.__taExtra) {
                    for (var d = 0; d < c.__taExtra.length; d++) D(a, c.__taExtra[d][0], c.__taExtra[d][1]);
            ...
            i = function(a, c, e, f) {
                ...
                var g = a.split(","),
                    h = function(a) {
                        h.__tauid = e.__tauid;
                        for (var f = d(a), i = 0; i < g.length; i++) b(f, g[i], c) && e.apply(f, arguments)
                    };
                return j(e, f, h), h
            },
            j = function(a, b, c) {
            ...
            k = function(a, b, c, d) {
                ...
                "focus" === b && null == a.getAttribute("tabindex") && a.setAttribute("tabindex", "1"), C(a, b, i(d, a, c, b), c)
            },
            l = function(a, b, c, f) {
                    ...
                    var g = function(b) {
                        ...
                        i = function(b) {
                            if (a.__tad && a.__tau && a.__tad[0] === a.__tau[0] && a.__tad[1] === a.__tau[1])
                                for (var c = 0; c < a.__taSmartClicks.length; c++) a.__taSmartClicks[c].apply(d(b), [b])
                        };
                                    ...
                                    if (j.down) {
                                        ...
                                        for (var g in m) {
                                            ...
                                            if (h.touches === e && (1 === h.taps || h.taps === j.taps))
                                                for (var i = 0; i < j[g].length; i++)(null == j[g][i][1] || b(c, j[g][i][1], f)) && j[g][i][0].apply(d(a), [a])
                                        }
                                    }
                                },
                                o = function() {
            ...
            o = function(a, b, c, d) {
                for (var e in c.__tamee[a]) c.__tamee[a][e].apply(d, [b])
            },
            p = function() {
                var a = [];
                return function(c, e, f, h) {
                    if (!c.__tamee) {
                        ...
                        var j = function(e) {
                            ...
                            k = function(e) {
                                for (var f = d(e), g = 0; g < a.length; g++) f != a[g] || b(e.relatedTarget || e.toElement, "*", f) || (f.__tamee.over = !1, a.splice(g, 1), o("mouseexit", e, c, f))
                            };
            ...
            C = function(a, b, c, d) {
                if (g(a, b, c), d.__tauid = c.__tauid, a.addEventListener) a.addEventListener(b, c, !1);
            ...
            D = function(a, b, d) {
                null != d && E(a, function() {
                    ...
                    if (h(e, b, d), null != d.__tauid)
                        if (e.removeEventListener) e.removeEventListener(b, d, !1), q && s[b] && e.removeEventListener(s[b], d, !1);
        ...
        this.Mottle = function(b) {
            b = b || {};
            var d = b.clickThreshold || 150,
                e = b.dblClickThreshold || 350,
                f = new p,
                g = new n(d, e),
                h = b.smartClicks,
                i = function(a, b, d, e) {
            ...
            this.remove = function(a) {
                return E(a, function() {
                    ...
                    if (a.__ta)
                        for (var b in a.__ta)
                            for (var d in a.__ta[b]) D(a, b, a.__ta[b][d]);
                ...
                var g = r && ("undefined" == typeof MouseEvent || null == e || e.constructor === MouseEvent),
                    h = q && !r && s[d] ? s[d] : d,
                    i = !(q && !r && s[d]),
                    j = w(e),
                    k = x(e),
                ...
                return E(b, function() {
                    ...
                    if (document.createEvent) {
                        var p = !i && !g && q && s[d] && !a.android,
                            r = p ? "TouchEvent" : "MouseEvents";
                        b = document.createEvent(r), o[r](b), n(b), m.dispatchEvent(b)
                    } else document.createEventObject && (b = document.createEventObject(), b.eventType = b.eventName = h, b.screenX = k[0], b.screenY = k[1], b.clientX = l[0], b.clientY = l[1], n(b), m.fireEvent("on" + h, b))
                }), this
            }
    ...
    function() {
        ...
        var a = function(a) {
            ...
            f = c > -1 && 9 > c,
            g = function(a) {
                if (f) return [a.clientX + document.documentElement.scrollLeft, a.clientY + document.documentElement.scrollTop];
                var b = i(a),
                    c = h(b, 0);
            ...
            k = "katavorio-drag-scope",
            l = ["stop", "start", "drag", "drop", "over", "out"],
            m = function() {},
            n = function() {
                return !0
            },
            ...
            s = "input,textarea,select,button,option",
            t = function(a, c, d) {
            ...
            v = function(c, f, h) {
                ...
                var j = [0, 0],
                    k = null,
                    l = !1,
                    m = this.params.consumeStartEvent !== !1,
                    o = this.el,
                    q = this.params.clone;
                this.params.scroll, f.multipleDrop !== !1;
                var s = f.snapThreshold || 5,
                ...
                this.downListener = function(b) {
                    ...
                    if (c && this.isEnabled() && this.canDrag()) {
                        ...
                        } else this.params.consumeFilteredEvents && r(b)
                    }
                ...
                f.events.start && E.start.push(f.events.start), f.events.stop && E.stop.push(f.events.stop), f.events.drag && E.drag.push(f.events.drag), this.on = function(a, b) {
                    E[a] && E[a].push(b)
                };
                var F = function(a, b) {
                    if (E[a])
                        for (var c = 0; c < E[a].length; c++) try {
                            E[a][c](b)
                        } catch (d) {}
                };
                this.notifyStart = function(a) {
                    ...
                    D.length = 0;
                    var d = this.constrain(this.toGrid([k[0] + a, k[1] + b]), o),
                        e = {
                            x: d[0],
                            y: d[1],
                            w: this.size[0],
        ...
        this.Katavorio = function(a) {
            ...
            var d = 1,
                ...
                g = (this.getMatchingDroppables = function(a) {
                    for (var b = [], c = {}, d = 0; d < a.scopes.length; d++) {
                        ...
                        if (e)
                            for (var f = 0; f < e.length; f++) e[f].canDrop(a) && !c[e[f].uuid] && e[f].el !== a.el && (c[e[f].uuid] = !0, b.push(e[f]))
                    }
                    return b
                }, function(b) {
                    b = b || {};
                    ...
                    for (var d = 0; d < l.length; d++) c.events[l[d]] = b[l[d]] || m;
                    return c.katavorio = this, c
                }.bind(this)),
                h = function(a, b) {
                    for (var c = 0; c < l.length; c++) b[l[c]] && a.on(l[c], b[l[c]])
                }.bind(this),
                i = {},
                n = a.css || {},
                p = a.scope || k;
            for (var r in j) i[r] = j[r];
            for (var r in n) i[r] = n[r];
            var t = a.inputFilterSelector || s;
            this.getInputFilterSelector = function() {
                ...
                return q(b, function(b) {
                    if (b = y(b), null != b)
                        if (null == b._katavorioDrag) {
                            var f = g(c);
                            b._katavorioDrag = new v(b, f, i, p), e(b._katavorioDrag, this._dragsByScope), d.push(b._katavorioDrag), a.addClass(b, i.draggable)
                        } else h(b._katavorioDrag, c)
                }.bind(this)), d
            }, this.droppable = function(b, c) {
                var d = [];
                return q(b, function(b) {
                    b = y(b), null != b && (b._katavorioDrop = new w(b, g(c), i, p), e(b._katavorioDrop, this._dropsByScope), d.push(b._katavorioDrop), a.addClass(b, i.droppable))
                }.bind(this)), d
            }, this.select = function(d) {
                return q(d, function() {
                    var d = y(this);
                    d && d._katavorioDrag && (c[d._katavorio] || (b.push(d._katavorioDrag), c[d._katavorio] = [d, b.length - 1], a.addClass(d, i.selected)))
                }), this
                ...
                return q(d, function() {
                    ...
                    if (d && d._katavorio) {
                        ...
                        if (e) {
                            for (var f = [], g = 0; g < b.length; g++) b[g].el !== d && f.push(b[g]);
                            b = f, delete c[d._katavorio], a.removeClass(d, i.selected)
                        }
                    }
                }), this
            ...
            q(["set", "add", "remove", "toggle"], function(a) {
                this[a + "Scope"] = function(b, c) {
                    u(b._katavorioDrag, c, this._dragsByScope, a + "Scope"), u(b._katavorioDrop, c, this._dropsByScope, a + "Scope")
                }.bind(this), this[a + "DragScope"] = function(b, c) {
                    u(b._katavorioDrag, c, this._dragsByScope, a + "Scope")
                }.bind(this), this[a + "DropScope"] = function(b, c) {
                    u(b._katavorioDrop, c, this._dropsByScope, a + "Scope")
                }.bind(this)
            }.bind(this)), this.snapToGrid = function(a, b) {
                for (var c in this._dragsByScope) o(this._dragsByScope[c], function(c) {
                    c.snap(a, b)
                })
            ...
            this.elementRemoved = function(a) {
                ...
                this._dragsByScope = {}, this._dropsByScope = {}, b = [], c = {}
            }
        }
    }.call(this),
    function() {
        var a = function(a) {
            ...
            k = j.jsPlumbUtil = {
                ...
                merge: function(b, e, g) {
                    ...
                    for (i in e)
                        if (null == k[i]) k[i] = e[i];
                        else if (c(e[i]) || d(e[i])) j[i] ? (h = [], h.push.apply(h, a(k[i]) ? k[i] : [k[i]]), h.push.apply(h, a(e[i]) ? e[i] : [e[i]]), k[i] = h) : k[i] = e[i];
                    else if (a(e[i])) h = [], a(k[i]) && h.push.apply(h, k[i]), h.push.apply(h, e[i]), k[i] = h;
                    else if (f(e[i])) {
                        f(k[i]) || (k[i] = {});
                ...
                extend: function(b, c) {
                    ...
                    for (c = a(c) ? c : [c], d = 0; d < c.length; d++)
                        for (var e in c[d].prototype) c[d].prototype.hasOwnProperty(e) && (b.prototype[e] = c[d].prototype[e]);
                    var f = function(a, b) {
                            return function() {
                    ...
                    if (arguments.length > 2)
                        for (d = 2; d < arguments.length; d++) g(arguments[d]);
                    return b
                },
                uuid: function() {
                    return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(a) {
                ...
                wrap: function(a, b, c) {
                    return a = a || function() {}, b = b || function() {},
                        function() {
                            var d = null;
                            try {
    ...
    function() {
        ...
        var a, b = this,
            ...
            l = window.jsPlumbUIComponent = function(a) {
                ...
                if (this.getDefaultType = function() {
                    ...
                    for (i in a.events) b.bind(i, a.events[i]);
                this.clone = function() {
                    var a = {};
        ...
        jsPlumbUtil.extend(l, jsPlumbUtil.EventGenerator, {
            ...
            removeType: function(a, b) {
                ...
                if (null != c) {
                    for (var g = 0, h = c.length; h > g; g++) e = f(c[g]) || e;
                    e && k(this, null, b)
                }
            },
            clearTypes: function(a) {
                for (var b = this._jsPlumb.types.length, c = 0; b > c; c++) m(this, 0), this._jsPlumb.types.splice(0, 1);
                k(this, {}, a)
            },
            toggleType: function(a, b, c) {
                ...
                if (null != d) {
                    for (var e = 0, f = d.length; f > e; e++) {
                        var g = jsPlumbUtil.indexOf(this._jsPlumb.types, d[e]); - 1 != g ? (m(this, g), this._jsPlumb.types.splice(g, 1)) : this._jsPlumb.types.push(d[e])
                    }
                    k(this, b, c)
                }
            },
            ...
            p = window.jsPlumbInstance = function(b) {
                ...
                var f = this,
                    ...
                    m = function(a) {
                        ...
                        return {
                            el: b,
                            id: jsPlumbUtil.isString(a) && null == b ? a : Y(b)
                        }
                    };
                ...
                for (var n in this.Defaults) j[n] = this.Defaults[n];
                var p, r = [];
                this.unbindContainer = function() {
                    if (null != p && r.length > 0)
                        for (var a = 0; a < r.length; a++) f.off(p, r[a][0], r[a][1])
                    ...
                    for (var c = function(a, b) {
                            var c = b.srcElement || b.target,
                                d = (c && c.parentNode ? c.parentNode._jsPlumb : null) || (c ? c._jsPlumb : null) || (c && c.parentNode && c.parentNode.parentNode ? c.parentNode.parentNode._jsPlumb : null);
                            d && (d.fire(a, d, b), f.fire(a, d.component || d, b))
                        }, d = function(a, b, c) {
                            r.push([a, c]), f.on(p, a, b, c)
                        }, e = function(a) {
                            d(a, "._jsPlumb_connector > *", function(b) {
                                c(a, b)
                            }), d(a, "._jsPlumb_endpoint, ._jsPlumb_endpoint > *, ._jsPlumb_endpoint svg *", function(b) {
                                c(a, b)
                            }), d(a, "._jsPlumb_overlay, ._jsPlumb_overlay *", function(b) {
                                c(a, b)
                            })
                        }, h = 0; h < g.length; h++) e(g[h]);
                    for (var i in x) {
                        var j = x[i].el;
                        j.parentNode === b && (b.removeChild(j), p.appendChild(j))
                    }
                ...
                var s = null,
                    ...
                    K = function(a, b, c, d) {
                        if (!q.headless && !D) {
                            var g = Y(a),
                                h = f.getDragManager().getElementsForDraggable(g);
                            null == c && (c = e());
                            var i = qb({
                                elId: g,
                                offset: b,
                            ...
                            if (f.anchorManager.redraw(g, b, c, null, d), h)
                                for (var k in h) f.anchorManager.redraw(h[k].id, b, c, h[k].offset, d, !0)
                        }
                    },
                    L = function(a) {
                        return w[a]
                    ...
                    M = function(a, b, c, e) {
                        if (!q.headless) {
                            var g = null == b ? !1 : b;
                            if (g && q.isDragSupported(a, f)) {
                                var h = c || f.Defaults.DragOptions;
                                if (h = q.extend({}, h), q.isAlreadyDraggable(a, f)) c.force && f.initDraggable(a, h);
                                else {
                                    var i = q.dragEvents.drag,
                                        j = q.dragEvents.stop,
                                        k = q.dragEvents.start,
                                        l = f.getElement(a),
                                        m = f.getDragManager().getDragAncestor(l),
                                        n = {
                                            left: 0,
                                            top: 0
                                        },
                                    ...
                                    pb(e, a), h[k] = d.wrap(h[k], function() {
                                        ...
                                        var b = [];
                                        b = 1 == arguments.length && arguments[0].selection && arguments[0].selection.length > 0 ? arguments[0].selection : [
                                            [a, f.getUIPosition(arguments, f.getZoom(), !0)]
                                        ];
                    ...
                    O = function(a, b) {
                        ...
                        return j("source", 0, this.sourceEndpointDefinitions) !== !1 && j("target", 1, this.targetEndpointDefinitions) !== !1 ? (c.sourceEndpoint && c.targetEndpoint && (N(c.sourceEndpoint, c.targetEndpoint) || (c = null)), c) : void 0
                    }.bind(f),
                    P = function(a) {
                        var b = f.Defaults.ConnectionType || f.getDefaultConnectionType();
                        a._jsPlumb = f, a.newConnection = P, a.newEndpoint = R, a.endpointsByUUID = w, a.endpointsByElement = v, a.finaliseConnection = Q, a.id = "con_" + I();
                        var c = new b(a);
                    ...
                    R = function(a, b) {
                        var c = f.Defaults.EndpointType || q.Endpoint,
                            d = q.extend({}, a);
                        ...
                        var e = new c(d);
                        return e.id = "ep_" + I(), pb(d.elementId, d.source), q.headless || f.getDragManager().endpointAdded(d.source, b), e
                    },
                    S = function(a, b, c) {
                        var d = v[a];
                        if (d && d.length)
                    ...
                    V = function(a) {
                        return q.each(a, function(a) {
                            var b = f.getAttribute(a, "id"),
                                c = null == A[b] ? !1 : A[b];
                            return c = !c, A[b] = c, f.setDraggable(a, c), c
                        }.bind(this))
                    },
                    W = function(a, b) {
                        var c = null;
                ...
                var Z = [{
                    ...
                    $ = function(a, b, c, d) {
                        ...
                        if (b.constructor == q.Endpoint) e = b, e.addConnection(a);
                ...
                this.setSource = function(a, b, c) {
                    ...
                    return v = {}, x = {}, w = {}, y = {}, z = {}, f.anchorManager.reset(), f.getDragManager().reset(), a || f.setSuspendDrawing(!1), f
                };
                ...
                this.unregisterEndpoint = function(a) {
                    ...
                    var c = Y(a),
                        d = v[c];
                    if (d && d.length)
                        for (var e = 0, g = d.length; g > e; e++) d[e].detachAll(b.fireEvent !== !1, b.forceDetach);
                    return f
                    ...
                    return a = a || {}, f.batch(function() {
                        for (var b in v) {
                            var c = v[b];
                            if (c && c.length)
                                for (var d = 0, e = c.length; e > d; d++) c[d].detachAll(a.fireEvent !== !1, a.forceDetach)
                        }
                        u.length = 0
                    }), f
                    ...
                    var b = {
                        ...
                        e = function(c) {
                            if (null != c && null == b.connections[c.id] && (a.dontUpdateHover || null == c._jsPlumb || c.setHover(!1), b.connections[c.id] = c, b.connectionCount++, d))
                                for (var e = 0; e < c.endpoints.length; e++) c.endpoints[e]._deleteOnDetach && g(c.endpoints[e])
                        },
                        g = function(c) {
                    ...
                    for (var h in b.connections) {
                        ...
                        i._jsPlumb && (jsPlumbUtil.removeWithFunction(u, function(a) {
                            return i.id == a.id
                        }), _(i, c, a.originalEvent), i.endpoints[0].detachFromConnection(i), i.endpoints[1].detachFromConnection(i), i.cleanup(!0), i.destroy(!0))
                    }
                    ...
                    if ("object" == typeof a && a.length)
                        for (c = 0, d = a.length; d > c; c++) e = m(a[c]), e.el && M(e.el, !0, b, e.id);
                    else e = m(a), e.el && M(e.el, !0, b, e.id);
                    return f
                };
                ...
                var hb = function(a, b) {
                    ...
                    lb = function(a) {
                        ...
                        return q.extend(b, {
                            ...
                            remove: function() {
                                for (var b = 0, c = a.length; c > b; b++) f.deleteObject({
                                    endpoint: a[b]
                                })
                            }
                        })
                ...
                this.init = function() {
                    ...
                    if (!q.connectorsInitialized) {
                        for (var d = 0; d < c.length; d++)
                            for (var e = 0; e < a.length; e++) b(a[e], c[d][1], c[d][0]);
                        q.connectorsInitialized = !0
                    }
                    t || (ob(), f.anchorManager = new q.AnchorManager({
                        jsPlumbInstance: f
                    ...
                    var a, b = function(a, b) {
                        if (q.Anchors[a]) return new q.Anchors[a](b);
                    ...
                    if ("string" == typeof c) g = b(arguments[0], {
                        ...
                        if (d.isArray(c[0]) || d.isString(c[0])) 2 == c.length && d.isObject(c[1]) ? d.isString(c[0]) ? (a = q.extend({
                            elementId: e,
                            jsPlumbInstance: f
                    ...
                    for (var e = [], g = 0, h = a.length; h > g; g++) "string" == typeof a[g] ? e.push(q.Anchors[a[g]]({
                        elementId: b,
                        jsPlumbInstance: c
                ...
                var sb = function(a, b, c, d, e) {
                    ...
                    tb = function(a, b, c, e, g) {
                        var h = new l(b),
                            i = b._jsPlumb.EndpointDropHandler({
                                jsPlumb: f,
                                enabled: function() {
                                ...
                                getEndpoint: function(c) {
                                    ...
                                    if ((null == d || null == d._jsPlumb) && (d = f.addEndpoint(a.el, b), d._mtNew = !0), b.uniqueEndpoint && (a.def.endpoint = d), d._doNotDeleteOnDetach = !1, d._deleteOnDetach = !0, c.isDetachable() && d.initDraggable(), null != d.anchor.positionFinder) {
                                        var e = f.getUIPosition(arguments, f.getZoom()),
                                            g = f.getOffset(a.el),
                                            h = f.getSize(a.el),
                                            i = d.anchor.positionFinder(e, g, h, d.anchor.constructorParams);
                                        d.anchor.x = i[0], d.anchor.y = i[1]
                                    }
                                    return d
                                },
                            ...
                            j = q.dragEvents.drop;
                        return c.scope = c.scope || b.scope || f.Defaults.Scope, c[j] = d.wrap(c[j], i, !0), g && (c[q.dragEvents.over] = function() {
                            return !0
                ...
                this.makeTarget = function(a, b, c) {
                    ...
                    for (var e = (!(d.deleteEndpointsOnDetach === !1), d.maxConnections || -1), f = function(a) {
                            ...
                            b.def = g, this.targetEndpointDefinitions[c] = g, tb(b, d, f, d.isSource === !0, !0)
                    ...
                    for (var g = e.maxConnections || 1, h = e.onMaxConnections, i = function(a) {
                            ...
                            this.sourceEndpointDefinitions[b] = i, a.def = i;
                            var j = q.dragEvents.stop,
                                l = q.dragEvents.drag,
                                m = q.extend({}, e.dragOptions || {}),
                                n = m.drag,
                                o = m.stop,
                                p = null,
                                r = !1;
                            m.scope = m.scope || e.scope, m[l] = d.wrap(m[l], function() {
                                ...
                                if (o && o.apply(this, arguments), this.currentlyDragging = !1, null != p._jsPlumb) {
                                    var a = e.anchor || this.Defaults.Anchor,
                                        c = p.anchor,
                                        d = p.connections[0],
                                        g = this.makeAnchor(a, b, this),
                                        h = p.element;
                                ...
                                if (3 !== d.which && 2 !== d.button) {
                                    ...
                                    if (j.enabled) {
                                        if (b = this.getId(this.getElement(a.el)), e.filter) {
                                            var l = jsPlumbUtil.isString(e.filter) ? sb(i, a.el, e.filter, this, e.filterExclude) : e.filter(i, a.el);
                                            if (l === !1) return
                                        }
                                        var n = this.select({
                                            source: b
                                        }).length;
                                        if (j.maxConnections >= 0 && j.uniqueEndpoint && n >= j.maxConnections) return h && h({
                                            element: a.el,
                                            maxConnections: g
                                        }, d), !1;
                                        var o = q.getPositionOnElement(i, c, k),
                                            s = {};
                            ...
                            tb(a, e, t, !0, e.isTarget === !0)
                        }.bind(this), j = a.length && a.constructor != String ? a : [a], l = 0, n = j.length; n > l; l++) i(m(j[l]));
                    return this
                }, this.unmakeSource = function(a, b) {
                    var c = m(a),
                        d = this.sourceEndpointDefinitions[c.id].trigger;
                    return d && f.off(c.el, "mousedown", d), b || delete this.sourceEndpointDefinitions[c.id], this
                }, this.unmakeEverySource = function() {
                    for (var a in this.sourceEndpointDefinitions) f.unmakeSource(a, !0);
                ...
                var ub = function(a, b) {
                        ...
                        for (var c = Y(a), d = 0; d < b.length; d++) {
                            var e = this[b[d]][c];
                            if (e) return e.def.scope || this.Defaults.Scope
                        }
                    }.bind(this),
                    vb = function(a, b, c) {
                        c = jsPlumbUtil.isArray(c) ? c : [c];
                        for (var d = Y(a), e = 0; e < c.length; e++) {
                            var f = this[c[e]][d];
                ...
                this.getScope = function(a) {
                    ...
                    vb(a, b, ["sourceEndpointDefinitions", "targetEndpointDefinitions"])
                }, this.setSourceScope = function(a, b) {
                    vb(a, b, "sourceEndpointDefinitions")
                }, this.setTargetScope = function(a, b) {
                    vb(a, b, "targetEndpointDefinitions")
                ...
                var wb = function(a, b, c, e) {
                        ...
                        if (d.isString(b)) f[b].enabled = e ? !f[b].enabled : c;
                        else if (b.length)
                ...
                this.toggleSourceEnabled = function(a) {
                    return wb("source", a, null, !0), this.isSourceEnabled(a)
                }, this.setSourceEnabled = function(a, b) {
                    return wb("source", a, b)
                    ...
                    return wb("target", a, null, !0), this.isTargetEnabled(a)
                ...
                this.repaint = function(a, b, c) {
                    ...
                    var d = function(a) {
                        var e, g, h = m(a),
                            i = v[h.id];
                        if (i)
                            for (c.push(h), e = 0, g = i.length; g > e; e++) f.deleteEndpoint(i[e]);
                ...
                this.remove = function(a, b) {
                    ...
                    f.silently(function() {
                        f.deleteEveryEndpoint(), f.unbind(), this.targetEndpointDefinitions = {}, this.sourceEndpointDefinitions = {}, u.length = 0, this.doReset && this.doReset()
                    }.bind(this))
                };
                var Ab = function(a) {
                ...
                this.clear = function() {
                    f.select().each(Ab), f.selectEndpoints().each(Ab), v = {}, w = {}
                }, this.setDefaultScope = function(a) {
                    return F = a, f
                }, this.setDraggable = T, this.setId = function(a, b, c) {
                    var d;
                    ...
                    var e = this.getConnections({
                        ...
                        f = this.getConnections({
                            target: d,
                            scope: "*"
                        }, !0);
                    b = "" + b, c ? a = this.getElement(b) : (a = this.getElement(d), this.setAttribute(a, "id", b)), v[b] = v[d] || [];
                    for (var g = 0, h = v[b].length; h > g; g++) v[b][g].setElementId(b), v[b][g].setReferenceElement(a);
                    delete v[d], this.sourceEndpointDefinitions[b] = this.sourceEndpointDefinitions[d], delete this.sourceEndpointDefinitions[d], this.targetEndpointDefinitions[b] = this.targetEndpointDefinitions[d], delete this.targetEndpointDefinitions[d], this.anchorManager.changeId(d, b), this.getDragManager().changeId(d, b), x[b] = x[d], delete x[d];
                ...
                }, this.doWhileSuspended = this.batch, this.getCachedData = X, this.timestamp = e, this.setRenderMode = function(a) {
                    if (a !== q.SVG && a !== q.VML) throw new TypeError("Render mode [" + a + "] not supported");
        ...
        jsPlumbUtil.extend(p, jsPlumbUtil.EventGenerator, {
            ...
            getAttribute: function(a, b) {
                return this.getAttribute(q.getElement(a), b)
            },
            ...
            registerEndpointTypes: function(a) {
                for (var b in a) this._endpointTypes[b] = q.extend({}, a[b])
            },
        ...
        "undefined" != typeof window && (window.jsPlumb = q), q.getInstance = function(a) {
            ...
            if (null != a)
                if ("string" == typeof a) b(q.getElement(a));
                else if (null != a.length)
                for (var c = 0; c < a.length; c++) b(q.getElement(a[c]));
            else b(a)
    ...
    function() {
        var a = this;
        a.jsPlumbUtil;
        var b = !!window.SVGAngle || document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"),
            c = function() {
                if (void 0 === c.vml) {
                    ...
                    f = function(a, b) {
                        for (var c = 0; c < b.length; c++)
                            if (a) - 1 == jsPlumbUtil.indexOf(e, b[c]) && e.push(b[c]);
                                ...
                                var d = jsPlumbUtil.indexOf(e, b[c]); - 1 != d && e.splice(d, 1)
                            }
                    };
        ...
        jsPlumb.extend(jsPlumbInstance.prototype, {
            ...
            hasClass: function(a, b) {
                return a = jsPlumb.getElement(a), a.classList ? a.classList.contains(b) : -1 != o(a).indexOf(b)
            },
        ...
        b.OverlayCapableJsPlumbUIComponent = function(a) {
            ...
            setHover: function(a) {
                if (this._jsPlumb && !this._jsPlumb.instance.isConnectionBeingDragged())
                    for (var b in this._jsPlumb.overlays) this._jsPlumb.overlays[b][a ? "addClass" : "removeClass"](this._jsPlumb.instance.hoverClass)
            },
    ...
    function() {
        ...
        var a = this,
            ...
            e = function(a, b) {
                ...
                b.appendElement(c);
                var d = b.getId(c);
                b.manage(d, c, !0), a.id = d, a.element = c
            },
        ...
        b.Endpoint = function(a) {
            ...
            this.bind("mouseover", function() {
                ...
                var h = null == g ? i(a, this) : g,
                    k = !1;
                return d = d !== !1, h >= 0 && (c || a._forceDetach || a.isDetachable() && a.isDetachAllowed(a) && this.isDetachAllowed(a) && j.checkCondition("beforeDetach", a, f)) && (j.deleteObject({
                    connection: a,
                    fireEvent: !b && d,
                    originalEvent: e,
                    deleteAttachedObjects: !1
                ...
                var d = this._jsPlumb.instance.getId(b),
                    e = this.elementId;
                return c.removeWithFunction(a.endpointsByElement[this.elementId], function(a) {
                    return a.id == this.id
                }.bind(this)), this.element = jsPlumb.getElement(b), this.elementId = j.getId(this.element), j.anchorManager.rehomeEndpoint(this, e, this.element), j.dragManager.endpointAdded(this.element), c.addToList(a.endpointsByElement, d, this), this
            ...
            this.initDraggable = function() {
                if (!p && b.isDragSupported(this.element)) {
                    var g = {
                        ...
                        q = a.dragOptions || {},
                        r = {},
                        s = b.dragEvents.start,
                        t = b.dragEvents.stop,
                        u = b.dragEvents.drag,
                        v = function() {
                            h = this.connectorSelector();
                            var b = !0;
                            this.isEnabled() || (b = !1), null != h || this.isSource || this.isTemporarySource || (b = !1), !this.isSource || !this.isFull() || null != h && this.dragAllowedWhenFull || (b = !1), null == h || h.isDetachable(this) || (b = !1);
                            var d = j.checkCondition(null == h ? "beforeDrag" : "beforeStartDetach", {
                                endpoint: this,
                                source: this.element,
                                sourceId: this.elementId,
                                connection: h
                            });
                            if (d === !1 && (b = !1), b === !1) return j.stopDrag && j.stopDrag(this.canvas), o.stopDrag(), !1;
                            ...
                            var q = this._jsPlumb.instance.getOffset(m.canvas),
                                r = this.canvas;
                            if (jsPlumb.setPosition(g.element, q), this.parentAnchor && (this.anchor = j.makeAnchor(this.parentAnchor, this.elementId, j)), j.setAttributes(this.canvas, {
                                    dragId: g.id,
                                    elId: this.elementId
                                }), this._jsPlumb.floatingEndpoint = f(this.getPaintStyle(), this.anchor, this.endpoint, this.canvas, g.element, j, l, this.scope), this.canvas.style.visibility = "hidden", null == h) this.anchor.locked = !0, this.setHover(!1, !1), h = k({
                                sourceEndpoint: this,
                        ...
                        w = function() {
                            if (j.setConnectionBeingDragged(!1), h && null != h.endpoints) {
                                var a = j.getDropEvent(arguments),
                                    b = j.getFloatingAnchorIndex(h);
                                if (h.endpoints[0 === b ? 1 : 0].anchor.locked = !1, h.removeClass(j.draggingClass), this._jsPlumb && (h.deleteConnectionNow || h.endpoints[b] == this._jsPlumb.floatingEndpoint) && i && h.suspendedEndpoint) {
                                    ...
                                    j.setDragScope(n[2], n[3]), h.endpoints[b] = h.suspendedEndpoint, h.isReattach() || h._forceReattach || h._forceDetach || !h.endpoints[0 === b ? 1 : 0].detach(h, !1, !1, !0, a, !0) ? (h.setHover(!1), h._forceDetach = null, h._forceReattach = null, this._jsPlumb.floatingEndpoint.detachFromConnection(h), h.suspendedEndpoint.addConnection(h), j.repaint(n[1])) : j.deleteObject({
                                        endpoint: c
                                    })
                                }
                            ...
                            g && g.element && j.remove(g.element, !1), m && j.deleteObject({
                                endpoint: m
            ...
            var t = function(d, e, f, g) {
                if (b.isDropSupported(this.element)) {
                    var h = a.dropOptions || j.Defaults.DropOptions || b.Defaults.DropOptions;
                    h = b.extend({}, h), h.scope = h.scope || this.scope;
                    var i = b.dragEvents.drop,
                        k = b.dragEvents.over,
                        l = b.dragEvents.out,
                        m = this,
                        n = j.EndpointDropHandler({
                    ...
                    h[i] = c.wrap(h[i], n, !0), h[k] = c.wrap(h[k], function() {
                        var a = b.getDragObject(arguments),
                            c = j.getAttribute(b.getElement(a), "dragId"),
                            d = j.floatingConnections[c];
                        if (null != d) {
                            var e = j.getFloatingAnchorIndex(d),
                        ...
                        var a = b.getDragObject(arguments),
                            c = null == a ? null : j.getAttribute(b.getElement(a), "dragId"),
                            d = c ? j.floatingConnections[c] : null;
                        if (null != d) {
                            var e = j.getFloatingAnchorIndex(d),
                                f = this.isTarget && 0 !== e || d.suspendedEndpoint && this.referenceEndpoint && this.referenceEndpoint.id == d.suspendedEndpoint.id;
                            f && (this.removeClass(j.endpointDropAllowedClass), this.removeClass(j.endpointDropForbiddenClass), d.endpoints[e].anchor.out())
                        }
                    }.bind(this)), j.initDroppable(d, h, "internal", e)
                }
            }.bind(this);
            ...
            return function(b) {
                ...
                var d = c.getDropEvent(arguments),
                    e = c.getDragObject(arguments),
                    f = c.getAttribute(e, "dragId"),
                    g = (c.getAttribute(e, "elId"), c.getAttribute(e, "originalScope")),
                    h = c.floatingConnections[f];
                if (null != h && (!h.suspendedEndpoint || null != h.suspendedEndpoint._jsPlumb)) {
                    var i = a.getEndpoint(h);
                    if (null != i) {
                        if (a.isRedrop(h, a)) return h._forceReattach = !0, h.setHover(!1), a.maybeCleanup && a.maybeCleanup(i), void 0;
                        var j = c.getFloatingAnchorIndex(h);
                        if (0 === j && !a.isSource || 1 === j && !a.isTarget) return a.maybeCleanup && a.maybeCleanup(i), void 0;
                        a.onDrop && a.onDrop(h), g && c.setDragScope(e, g);
                        var k = a.isFull(b);
                        if (k && i.fire("maxConnections", {
                                endpoint: this,
                                connection: h,
                                maxConnections: i._jsPlumb.maxConnections
                            }, d), !k && (0 !== j || a.isSource) && (1 != j || a.isTarget) && a.enabled()) {
                            var l = !0;
                            0 === j ? (h.source = a.element, h.sourceId = a.elementId) : (h.target = a.element, h.targetId = a.elementId), h.suspendedEndpoint && h.suspendedEndpoint._jsPlumb && h.suspendedEndpoint.id != i.id && (h.isDetachAllowed(h) && h.endpoints[j].isDetachAllowed(h) && h.suspendedEndpoint.isDetachAllowed(h) && c.checkCondition("beforeDetach", h) || (l = !1));
                            var m = function(a) {
                                    h.endpoints[j].detachFromConnection(h), h.suspendedEndpoint && h.suspendedEndpoint.detachFromConnection(h), h.endpoints[j] = i, i.addConnection(h);
                                    var b = i.getParameters();
                                    for (var e in b) h.setParameter(e, b[e]);
                                    if (h.suspendedEndpoint) {
                                        var f = h.suspendedEndpoint.elementId;
                                        c.fireMoveEvent({
                                            index: j,
                                            originalSourceId: 0 === j ? f : h.sourceId,
                                            newSourceId: 0 === j ? i.elementId : h.sourceId,
                                            originalTargetId: 1 == j ? f : h.targetId,
                                            newTargetId: 1 == j ? i.elementId : h.targetId,
                                            originalSourceEndpoint: 0 === j ? h.suspendedEndpoint : h.endpoints[0],
                                            newSourceEndpoint: 0 === j ? i : h.endpoints[0],
                                            originalTargetEndpoint: 1 == j ? h.suspendedEndpoint : h.endpoints[1],
                                            newTargetEndpoint: 1 == j ? i : h.endpoints[1],
                                            connection: h
                                        }, d)
                                    ...
                                    jsPlumbUtil.isObject(a) && h.mergeData(a), c.finaliseConnection(h, null, d), h.setHover(!1)
                                }.bind(this),
                                n = function() {
                            ...
                            if (l = l && a.isDropAllowed(h.sourceId, h.targetId, h.scope, h, i)) return m(l), !0;
                            n()
                        }
                        a.maybeCleanup && a.maybeCleanup(i), c.currentlyDragging = !1
                    }
                }
            }
        }
    ...
    function() {
        ...
        var a = this,
            ...
            d = function(a, c, d, e, f) {
                if (!a.Defaults.DoNotThrowErrors && null == jsPlumb.Connectors[c][d]) throw {
        ...
        b.Connection = function(a) {
            ...
            var u = ["default", a.type, this.endpoints[0].connectionType, this.endpoints[1].connectionType].join(" ");
            ...
            paint: function(a) {
                if (!this._jsPlumb.instance.isSuspendDrawing() && this._jsPlumb.visible) {
                    ...
                    if (null == b || b != this._jsPlumb.lastPaintedAt) {
                        ...
                        var q = parseFloat(this._jsPlumb.paintStyleInUse.lineWidth || 1) / 2,
                            r = parseFloat(this._jsPlumb.paintStyleInUse.lineWidth || 0),
                            s = {
            ...
            var d = {},
                ...
                o = function(a, b, c, d, e, f) {
                    ...
                    for (var m = 0; m < i.length; m++)
                        for (var n = 0; n < i.length; n++) m != n && k.push({
                            source: i[m],
                            target: i[n],
        ...
        b.Segments = {
            ...
            Straight: function(a) {
                ...
                this.findClosestPointOnPath = function(a, b) {
                    ...
                    else if (1 / 0 == e || e == -1 / 0) k.x = g, k.y = l(i, j, b) ? b : m(i, j, b);
                    else {
                        var n = i - e * g,
                            o = b - f * a,
                            p = (o - n) / (e - f),
            ...
            this.computeMaxSize = function() {
                ...
                if (a.pointAlongPathFrom) {
                    ...
                    var q = {
                        ...
                        r = e.strokeStyle || g.strokeStyle,
                        s = e.fillStyle || g.strokeStyle,
                        t = e.lineWidth || g.lineWidth;
                    return {
                        component: a,
                        d: q,
                        lineWidth: t,
    ...
    function() {
        ...
        var a = this,
            ...
            d = function(a) {
                ...
                var c, d, e = b.Connectors.AbstractConnector.apply(this, arguments),
                    f = null == a.midpoint ? .5 : a.midpoint,
                    g = a.alwaysRespectStubs === !0,
                    h = null,
                    i = null,
                    j = null,
                    k = null != a.cornerRadius ? a.cornerRadius : 0,
                    l = function(a) {
                ...
                this.setSegments = function(a) {
                    ...
                    var k = a.startStubX + (a.endStubX - a.startStubX) * f,
                        l = a.startStubY + (a.endStubY - a.startStubY) * f,
                        n = {
                            x: [0, 1],
                            y: [1, 0]
                        },
                        ...
                        r = {
                            ...
                            opposite: function(c, d, f, g) {
                                var h = a,
                                    ...
                                    m = h["is" + c.toUpperCase() + "GreaterThanStubTimes2"];
                    ...
                    if (z)
                        for (var A = 0; A < z.length; A++) m(c, z[A][0], z[A][1], a);
        ...
        var a = this,
            ...
            f = function(a) {
                ...
                var c = b.Connectors.AbstractConnector.apply(this, arguments),
                    f = a.curviness || 10,
                    g = a.margin || 5,
                    h = a.proximityLimit || 80,
                    i = a.orientation && "clockwise" === a.orientation,
                    j = a.loopbackRadius || 25,
                    k = a.showLoopback !== !1;
                this._compute = function(a, b) {
                    var l = Math.abs(b.sourcePos[0] - b.targetPos[0]),
                        m = Math.abs(b.sourcePos[1] - b.targetPos[1]);
                    if (k && b.sourceEndpoint.elementId === b.targetEndpoint.elementId) {
                        ...
                        var v = b.sourcePos[0] < b.targetPos[0] ? 0 : l,
                            w = b.sourcePos[1] < b.targetPos[1] ? 0 : m,
                            x = b.sourcePos[0] < b.targetPos[0] ? l : 0,
                            y = b.sourcePos[1] < b.targetPos[1] ? m : 0;
                        ...
                        var z = (v + x) / 2,
                            A = (w + y) / 2,
                            B = d(v, w, x, y),
                            C = Math.sqrt(Math.pow(x - v, 2) + Math.pow(y - w, 2)),
                            D = e(z, A, B, b.sourcePos, b.targetPos, f, f, C, h);
            ...
            d = function(a) {
                ...
                this.type = "Bezier", this.getCurviness = function() {
                    ...
                    var d = b.sourcePos,
                        ...
                        j = d[0] < e[0] ? 0 : f,
                        k = d[1] < e[1] ? 0 : g,
                        l = this._findControlPoint([h, i], d, e, b.sourceEndpoint, b.targetEndpoint, a.so, a.to),
                        m = this._findControlPoint([j, k], e, d, b.targetEndpoint, b.sourceEndpoint, a.to, a.so);
                    c.addSegment(this, "Bezier", {
                        x1: h,
                        y1: i,
                        x2: j,
    ...
    function() {
        ...
        var a = this,
            ...
            d = function(a, b) {
                ...
                var c = a,
                    ...
                    f = function(a) {
                        return e(parseInt(255 * a, 10))
                    },
                    g = /(rgb[a]?\()(.*)(\))/;
                if (a.match(g)) {
                    var h = a.match(g)[2].split(",");
                    c = "#" + e(h[0]) + e(h[1]) + e(h[2]), b || 4 != h.length || (c += f(h[3]))
                }
                return c
            },
            e = {
        ...
        if (document.createStyleSheet && document.namespaces) {
            var g = [".jsplumb_vml", "jsplumb\\:textbox", "jsplumb\\:oval", "jsplumb\\:rect", "jsplumb\\:stroke", "jsplumb\\:shape", "jsplumb\\:group"],
                h = "behavior:url(#default#VML);position:absolute;";
            f = document.createStyleSheet();
            for (var i = 0; i < g.length; i++) f.addRule(g[i], h);
        ...
        var j = 1e3,
            ...
            l = function(a, b, c, d, e, f) {
                ...
                return f ? e.appendElement(g, d) : d.appendChild(g), g.className = (c["class"] ? c["class"] + " " : "") + "jsplumb_vml", m(g, b), k(g, c), g
            },
            m = function(a, b, c) {
            ...
            n = b.vml.convertValue = function(a) {
                return Math.floor(a * j)
            },
            o = function(a, b, c, d) {
            ...
            p = function(a, b, c, e) {
                ...
                if (b.strokeStyle) {
                    f.stroked = "true";
                    var g = d(b.strokeStyle, !0);
                    f.strokecolor = g, o(f, g, "stroke", c), f.strokeweight = b.lineWidth + "px"
                } else f.stroked = "false";
                if (b.fillStyle) {
                    f.filled = "true";
                    var h = d(b.fillStyle, !0);
                    f.fillcolor = h, o(f, h, "fill", c)
                } else f.filled = "false";
                if (b.dashstyle) null == c.strokeNode ? c.strokeNode = l("stroke", [0, 0, 0, 0], {
                    dashstyle: b.dashstyle
                }, a, e) : c.strokeNode.dashstyle = b.dashstyle;
                else if (b["stroke-dasharray"] && b.lineWidth) {
                    for (var i = -1 == b["stroke-dasharray"].indexOf(",") ? " " : ",", j = b["stroke-dasharray"].split(i), m = "", n = 0; n < j.length; n++) m += Math.floor(j[n] / b.lineWidth) + i;
                    null == c.strokeNode ? c.strokeNode = l("stroke", [0, 0, 0, 0], {
                        dashstyle: m
                    }, a, e) : c.strokeNode.dashstyle = m
                }
                k(a, f)
            },
            q = function() {
                ...
                b.jsPlumbUIComponent.apply(this, arguments), this.opacityNodes = {
                    ...
                    a.opacityNodes.stroke = l("stroke", [0, 0, 1, 1], {
                        opacity: "0.0"
                    }, b, a._jsPlumb.instance), a.opacityNodes.fill = l("fill", [0, 0, 1, 1], {
                        opacity: "0.0"
        ...
        c.extend(q, b.jsPlumbUIComponent, {
            cleanup: function() {
        ...
        var r = b.ConnectorRenderers.vml = function(a, d) {
            this.strokeNode = null, this.canvas = null, q.apply(this, arguments);
            var f = this._jsPlumb.instance.connectorClass + (a.cssClass ? " " + a.cssClass : "");
            this.paint = function(g) {
                if (null !== g) {
                    this.w = Math.max(this.w, 1), this.h = Math.max(this.h, 1);
                    for (var h = this.getSegments(), i = {
                            path: ""
                        }, n = [this.x, this.y, this.w, this.h], o = 0; o < h.length; o++) i.path += b.Segments.vml.SegmentRenderer.getPath(h[o]), i.path += " ";
                    if (g.outlineColor) {
                        var q = g.outlineWidth || 1,
                            r = g.lineWidth + 2 * q,
                            s = {
                                strokeStyle: c.convertStyle(g.outlineColor),
                                lineWidth: r
                            };
                        for (var t in e) s[t] = g[t];
                        null == this.bgCanvas ? (i["class"] = f, i.coordsize = n[2] * j + "," + n[3] * j, this.bgCanvas = l("shape", n, i, a.parent, this._jsPlumb.instance, !0), m(this.bgCanvas, n), this.appendDisplayElement(this.bgCanvas, !0), this.initOpacityNodes(this.bgCanvas, ["stroke"]), this.bgCanvas._jsPlumb = d) : (i.coordsize = n[2] * j + "," + n[3] * j, m(this.bgCanvas, n), k(this.bgCanvas, i)), p(this.bgCanvas, s, this)
                    }
                    null == this.canvas ? (i["class"] = f, i.coordsize = n[2] * j + "," + n[3] * j, this.canvas = l("shape", n, i, a.parent, this._jsPlumb.instance, !0), this.appendDisplayElement(this.canvas, !0), this.initOpacityNodes(this.canvas, ["stroke"]), this.canvas._jsPlumb = d) : (i.coordsize = n[2] * j + "," + n[3] * j, m(this.canvas, n), k(this.canvas, i)), p(this.canvas, g, this, this._jsPlumb.instance)
                }
            }
        };
        c.extend(r, q, {
        ...
        var s = b.VmlEndpoint = function(a) {
            q.apply(this, arguments), this._jsPlumb.vml = null, this.canvas = document.createElement("div"), this.canvas.style.position = "absolute", this._jsPlumb.clazz = this._jsPlumb.instance.endpointClass + (a.cssClass ? " " + a.cssClass : ""), a._jsPlumb.appendElement(this.canvas, a.parent), this.paint = function(a, b) {
                var d = {},
                    e = this._jsPlumb.vml;
                c.sizeElement(this.canvas, this.x, this.y, this.w, this.h), null == this._jsPlumb.vml ? (d["class"] = this._jsPlumb.clazz, e = this._jsPlumb.vml = this.getVml([0, 0, this.w, this.h], d, b, this.canvas, this._jsPlumb.instance), this.appendDisplayElement(e, !0), this.appendDisplayElement(this.canvas, !0), this.initOpacityNodes(e, ["fill"])) : (m(e, [0, 0, this.w, this.h]), k(e, d)), p(e, a, this)
            }
        };
        c.extend(s, q), b.Segments.vml = {
            SegmentRenderer: {
                getPath: function(a) {
                    return {
                        Straight: function(a) {
                            var b = a.params;
                            return "m" + n(b.x1) + "," + n(b.y1) + " l" + n(b.x2) + "," + n(b.y2) + " e"
                        },
                        Bezier: function(a) {
                            var b = a.params;
                            return "m" + n(b.x1) + "," + n(b.y1) + " c" + n(b.cp1x) + "," + n(b.cp1y) + "," + n(b.cp2x) + "," + n(b.cp2y) + "," + n(b.x2) + "," + n(b.y2) + " e"
                        },
                        Arc: function(a) {
                            var b = a.params,
                                ...
                                g = function() {
                                    if (b.loopback) return "0,0," + n(2 * b.r) + "," + n(2 * b.r);
                                    var f = [null, [function() {
                                            return [c, d]
                                        }, function() {
                                            return [c - b.r, d - b.r]
                                    ...
                                    return n(f[0]) + "," + n(f[1]) + "," + n(f[0] + 2 * b.r) + "," + n(f[1] + 2 * b.r)
                                };
                            return f + " " + g() + "," + n(b.x1) + "," + n(b.y1) + "," + n(b.x2) + "," + n(b.y2) + " e"
                        }
                    }[a.type](a)
                }
            }
        }, b.Endpoints.vml.Dot = function() {
            b.Endpoints.Dot.apply(this, arguments), s.apply(this, arguments), this.getVml = function(a, b, c, d, e) {
                return l("oval", a, b, d, e)
            }
        }, c.extend(b.Endpoints.vml.Dot, s), b.Endpoints.vml.Rectangle = function() {
            b.Endpoints.Rectangle.apply(this, arguments), s.apply(this, arguments), this.getVml = function(a, b, c, d, e) {
                return l("rect", a, b, d, e)
            }
        }, c.extend(b.Endpoints.vml.Rectangle, s), b.Endpoints.vml.Image = b.Endpoints.Image, b.Endpoints.vml.Blank = b.Endpoints.Blank, b.Overlays.vml.Label = b.Overlays.Label, b.Overlays.vml.Custom = b.Overlays.Custom;
        var t = function(a, b) {
            a.apply(this, b), q.apply(this, b);
            var d = this;
            this.canvas = null, this.isAppendedAtTopLevel = !0;
            var e = function(a) {
                return "m " + n(a.hxy.x) + "," + n(a.hxy.y) + " l " + n(a.tail[0].x) + "," + n(a.tail[0].y) + " " + n(a.cxy.x) + "," + n(a.cxy.y) + " " + n(a.tail[1].x) + "," + n(a.tail[1].y) + " x e"
            };
            this.paint = function(a, f) {
                if (a.component.canvas && f) {
                    ...
                    var n = Math.min(h.hxy.x, h.tail[0].x, h.tail[1].x, h.cxy.x),
                        o = Math.min(h.hxy.y, h.tail[0].y, h.tail[1].y, h.cxy.y),
                        p = Math.max(h.hxy.x, h.tail[0].x, h.tail[1].x, h.cxy.x),
                        q = Math.max(h.hxy.y, h.tail[0].y, h.tail[1].y, h.cxy.y),
                        r = Math.abs(p - n),
                        s = Math.abs(q - o),
                        t = [n, o, r, s];
                    if (g.path = e(h), g.coordsize = i.w * j + "," + i.h * j, t[0] = i.x, t[1] = i.y, t[2] = i.w, t[3] = i.h, null == d.canvas) {
                        var u = i._jsPlumb.overlayClass || "",
                            v = b && 1 == b.length ? b[0].cssClass || "" : "";
                        g["class"] = v + " " + u, d.canvas = l("shape", t, g, i.canvas.parentNode, i._jsPlumb.instance, !0), i.appendDisplayElement(d.canvas, !0)
                    } else m(d.canvas, t), k(d.canvas, g)
                }
            }, this.cleanup = function() {
                null != this.canvas && this._jsPlumb.instance.removeElement(this.canvas)
            }
        };
        c.extend(t, [q, b.Overlays.AbstractOverlay], {
            setVisible: function(a) {
                this.canvas.style.display = a ? "block" : "none"
            }
        }), b.Overlays.vml.Arrow = function() {
            t.apply(this, [b.Overlays.Arrow, arguments])
        }, c.extend(b.Overlays.vml.Arrow, [b.Overlays.Arrow, t]), b.Overlays.vml.PlainArrow = function() {
            t.apply(this, [b.Overlays.PlainArrow, arguments])
        }, c.extend(b.Overlays.vml.PlainArrow, [b.Overlays.PlainArrow, t]), b.Overlays.vml.Diamond = function() {
            t.apply(this, [b.Overlays.Diamond, arguments])
        }, c.extend(b.Overlays.vml.Diamond, [b.Overlays.Diamond, t])
    }.call(this),
    function() {
        "use strict";
        var a = this,
