...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_measurementId": "G-WMY7V8TFPS",
    ...
    */
    ...
    Vd.Ve = Number("") || 0;
    Vd.fa = "dataLayer";
    Vd.Oh = "ChEI8LXjmgYQ/Kv0/9rE88LvARIkAFsmP3wWCQd17NxcNWnU8SrfNYYNJRY+NSNHSWWMzu1+BhmrGgIn6Q\x3d\x3d";
    var Yd = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    var qk = nk,
        rk = "https://www.googletagmanager.com/a?id=" + Qg.M + "&cv=2",
        sk = {
    ...
    var Vl, Wl = function() {
        ...
        Zl = function(a, b, c) {
            c = void 0 === c ? !1 : c;
            a && (b.m[R.g.Ie] = a.architecture, b.m[R.g.Je] = a.bitness, a.fullVersionList && (b.m[R.g.Ke] = a.fullVersionList.map(function(d) {
                return encodeURIComponent(d.brand || "") + ";" + encodeURIComponent(d.version || "")
            }).join("|")), c && (b.m[R.g.yg] =
                a.mobile ? "1" : "0"), b.m[R.g.Le] = a.model, b.m[R.g.Me] = a.platform, b.m[R.g.Ne] = a.platformVersion, b.m[R.g.Oe] = a.wow64 ? "1" : "0")
        };
